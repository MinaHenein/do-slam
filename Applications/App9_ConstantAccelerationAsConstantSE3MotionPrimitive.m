...
config.set('constantSE3Motion',constantSE3ObjectMotion);
    ...
    config.set('measurementsFileName','app9_measurementsNoSE3.graph')
    config.set('groundTruthFileName','app9_groundTruthNoSE3.graph')
    ...
    config.set('measurementsFileName','app9_measurements.graph');
    config.set('groundTruthFileName','app9_groundTruth.graph');
    sensor.generateMeasurements(config);
...
%plot results
resultsNoSE3Cell = graphFileToCell(config,'app9_resultsNoSE3.graph');
resultsCell = graphFileToCell(config,'app9_results.graph');
