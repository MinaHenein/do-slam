function config = setHighErrorAppConfig(config)
...
config.set('stdPosePrior',[0.05,0.05,0.05,orientation(1),orientation(2),orientation(3)]');

% set point prior error
config.set('stdPointPrior',[0.05,0.05,0.05]');
