function convertGraphFileToGTSAM(config,filepath)
...
switch label
    case config.posePoseEdgeLabel
        ...
        CStrOutput(i) =  cellstr(sprintf(poseEdgeFormat,gtsamLabel,index1,index2,value(1:3),...
...
filepath = strcat(filepath(1:end-6),'GTSAM.graph');
