...
hold on
h(6) = plot3(obj5Poses(1,:),obj5Poses(2,:),obj5Poses(3,:),'.','MarkerSize',15,'Color',rgb(colors{5}),'LineStyle','none');
hold on
h(7) = plot3(obj6Poses(1,:),obj6Poses(2,:),obj6Poses(3,:),'.','MarkerSize',15,'Color',rgb(colors{6}),'LineStyle','none');
hold on
h(8) = plot3(obj7Poses(1,:),obj7Poses(2,:),obj7Poses(3,:),'.','MarkerSize',15,'Color',rgb(colors{7}),'LineStyle','none');
hold on
h(9) = plot3(obj8Poses(1,:),obj8Poses(2,:),obj8Poses(3,:),'.','MarkerSize',15,'Color',rgb(colors{8}),'LineStyle','none');
xlabel('x (m)')
ylabel('y (m)')
zlabel('z (m)')
axis equal
...
xlim([-2 10])
zlim([0 22])
legend(h, {' static structure ',' 8.8 m/s ',' 9.5 m/s ',' 8.1 m/s ',' 8.7 m/s ',...
    ' 9.3 m/s ',' 9.2 m/s ',' 10.2 m/s ',' 10.7 m/s '},'Position',[0.4 0.75 0.1 0.2]);
view(0,0)
AxesH    = gca;
