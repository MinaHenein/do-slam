...
for i=2:size(synchronisedData,1)
    ...
    vx = odomMeas(synchronisedData(i,2),2);
    vy = odomMeas(synchronisedData(i,2),3);
    vz = odomMeas(synchronisedData(i,2),4);
    
    wx = imuMeas(synchronisedData(i,3),2);
    wy = imuMeas(synchronisedData(i,3),3);
    wz = imuMeas(synchronisedData(i,3),4);
