...
% converge -- when every pair of landmarks are connected to a new H
%--------------------------------------------------------------------------
%% 1. Config
% time
function Test13_newSE3MotionVertexPerLandmarksPair()
...
config.set('groundTruthFileName',strcat('test13_',num2str(nSteps),'_',...
    num2str(SE3VertexInitialization),'_',num2str(noiseLevel),'groundTruthNoSE3.graph'));
config.set('measurementsFileName',strcat('test13_',num2str(nSteps),'_',...
...
initialGraphN.saveGraphFile(config,strcat('test13_',num2str(nSteps),'_',...
...
%save results to graph file
graphN.saveGraphFile(config,strcat('test13_',num2str(nSteps),'_',...
...
save(strcat('Data/test13_results/resultsNoSE3_',num2str(nSteps),'_',...
    num2str(SE3VertexInitialization),'_',num2str(noiseLevel)),'resultsNoSE3')
save(strcat('Data/test13_results/resultsSE3_',num2str(nSteps),'_',...
    num2str(SE3VertexInitialization),'_',num2str(noiseLevel)),'resultsSE3')
save(strcat('Data/test13_results/H_',num2str(nSteps),'_',...
...
save(strcat('Data/test13_results/edges_',num2str(nSteps),'_',...
...
figure
for i = sequence
    resultsSE3 = load(strcat('Data/test13_results/resultsSE3_',num2str(fibonacci(i)),'_',...
    num2str(SE3VertexInitialization),'_',num2str(noiseLevel)));
    resultsSE3 = resultsSE3.resultsSE3;
    resultsNoSE3 = load(strcat('Data/test13_results/resultsNoSE3_',num2str(fibonacci(i)),'_',...
    num2str(SE3VertexInitialization),'_',num2str(noiseLevel)));
