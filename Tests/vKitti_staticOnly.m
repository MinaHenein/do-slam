...
config.set('measurementsFileName','vKitti_staticOnlyMeas_1.graph')
config.set('groundTruthFileName','vKitti_staticOnlyGT_1.graph')
...
initialGraphN.saveGraphFile(config,'vKitti_staticOnly.graph');
