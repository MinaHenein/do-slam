...
config.set('measurementsFileName','finalNoiseSequence0002_rcnn_newNoise_dataA_MeasStaticOnly.graph')
config.set('groundTruthFileName','finalNoiseSequence0002_rcnn_newNoise_dataA_GTStaticOnly.graph')
...
initialGraphN.saveGraphFile(config,'finalNoiseSequence0002_rcnn_newNoise_dataA_staticOnlyResults.graph');
...
%plot results
resultsNoSE3Cell = graphFileToCell(config,'finalNoiseSequence0002_rcnn_newNoise_dataA_staticOnlyResults.graph');
plotGraphFileICRA(config,resultsNoSE3Cell,'initial',...
    resultsNoSE3.relPose.get('R3xso3Pose'),resultsNoSE3.firstGTPose,resultsNoSE3.posePointsN.get('R3xso3Pose'))