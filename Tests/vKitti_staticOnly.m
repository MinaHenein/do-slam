...
config.set('measurementsFileName','finalNoiseSequence0006_0to170_rcnn_newNoise_dataA_MeasStaticOnly.graph')
config.set('groundTruthFileName','finalNoiseSequence0006_0to170_rcnn_newNoise_dataA_GTStaticOnly.graph')
...
initialGraphN.saveGraphFile(config,'finalNoiseSequence0006_0to170_rcnn_newNoise_dataA_staticOnlyResults.graph');
...
%plot results
resultsNoSE3Cell = graphFileToCell(config,'finalNoiseSequence0006_0to170_rcnn_newNoise_dataA_staticOnlyResults.graph');
