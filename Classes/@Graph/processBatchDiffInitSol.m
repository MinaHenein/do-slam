function [solver] = processBatchDiffInitSol(obj,config,measurementsCell,groundTruthCell,initialSolGraph)
...
nPoseVertices = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
graph0Cell = graphFileToCell(config,initialSolGraph);
graph0 = Graph();
graph0 = graph0.graphFileToGraphVerticesOnly(config,graph0Cell);
graph0PoseIndexes = graph0.identifyVertices('pose');
graph0PointIndexes = graph0.identifyVertices('point');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%loop over nSteps
    ...
    for j = 1:nRows
        ...
        switch jRow{1}
            case config.labelPosePriorEdge %posePrior
                ...
                nPoseVertices = nPoseVertices + 1;
                obj.vertices(jRow{4}).value = graph0.vertices(graph0PoseIndexes(nPoseVertices)).value;
            ...
            case config.labelPosePointEdge
                ...
                if jRow{4} > obj.nVertices
                    ...
                    nPointVertices = nPointVertices + 1; 
                    obj.vertices(jRow{4}).value = graph0.vertices(graph0PointIndexes(nPointVertices)).value;
                end
