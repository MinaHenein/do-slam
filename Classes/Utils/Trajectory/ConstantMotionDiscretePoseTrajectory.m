%--------------------------------------------------------------------------
% Author: Yash Vyas - yjvyas@gmail.com - 03/09/17
% Contributors:
%--------------------------------------------------------------------------

classdef ConstantMotionDiscretePoseTrajectory < DiscretePoseTrajectory
    %CONSTANTMOTIONDISCRETEPOSETRAJECTORY is a child class trajectory of
    ...
    methods(Access = public)
        function self = ConstantMotionDiscretePoseTrajectory(t,initialPose,motion,property)
            switch nargin
