function [obj] = constructFixedDistanceEdge(obj,config,edgeRow)
%CONSTRUCTFIXEDANGLEEDGE constructs edge representing distance between two
%planes - there is no output vertex for this edge
...
obj = obj.updateFixedDistanceEdge(edgeIndex);
